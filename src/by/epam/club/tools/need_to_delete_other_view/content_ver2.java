...
public class content_ver2 {
        ...
        public content_ver2(HttpServletRequest httpServletRequest) {
            ...
            if (requestPartName != null && requestParts != null && !requestParts.isEmpty() && requestParts.stream().anyMatch(part -> part.getName().equals(requestPartName))) {
                try {
                    ...
                    requestParts.stream().filter(part -> {
                        ...
                        String fileExtension = fileName.substring(fileName.lastIndexOf(DOT)).replaceAll(QUOTE, EMPTY_STRING_PARAM);

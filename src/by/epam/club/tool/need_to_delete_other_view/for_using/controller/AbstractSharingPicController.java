...
import by.epam.club.tool.need_to_delete_other_view.for_using.Router;
import by.epam.club.tool.need_to_delete_other_view.for_using.TransmisionType;
import by.epam.club.exception.ControllerException;
import by.epam.club.tool.need_to_delete_other_view.command1.ActionFactory;
...
public abstract class AbstractSharingPicController extends HttpServlet {
    public void processRequest(HttpServletRequest request, HttpServletResponse response, RequestContent content) throws ControllerException {
      //  try {
            ...
            ActionCommand_new command = ActionFactory.defineCommand(content);
            Router router;

/*
package by.epam.club.tool.need_to_delete_other_view.command1.impl_old;

        import by.epam.club.tool.need_to_delete_other_view.command1.ActionCommand;
        import by.epam.club.tool.need_to_delete_other_view.command1.RequestContent;
        import by.epam.club.tool.need_to_delete_other_view.command1.Router;
        import by.epam.club.tool.need_to_delete_other_view.command1.TransmisionType;
        import by.epam.club.tool.need_to_delete_other_view.command1.service.AccountLogic;

        import javax.management.relation.Role;

        import static by.epam.club.tool.need_to_delete_other_view.command1.Parameter.*;

...
/**
 * Command for mark 'User is unblocked'
 *
 * @author Maeuski Igor
 * @version 1.0
...
public class UnBlockedUserCommand implements ActionCommand {
    private static final Logger LOGGER = LogManager.getLogger(UnBlockedUserCommand.class);

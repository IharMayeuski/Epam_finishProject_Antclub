...
/**
 * Command for mark 'User is restored'
 *
 * @author Maeuski Igor
 * @version 1.0
...
public class UnDeleteUserCommand implements ActionCommand {
    private static final Logger LOGGER = LogManager.getLogger(UnDeleteUserCommand.class);

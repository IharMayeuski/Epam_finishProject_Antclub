...
public class Parameter {
    public static String RESOURCE_CONFIG = "resource.config";
    public static final String PAGE_ID_PARAM = "page_id";
    ...
    public static final String ADMIN_PAGE_FORVARD = "path.page.admin.main";
    ...
    public static final String DELETE_ACCOUNT_USER_PAGE= "delete.account.user";
    public static final String LOOK_TYPE_PAGE ="path.page.look.type";
    ...
    public static final String NEW_PASSWORD_SENT_ON_EMAIL="password.send";
    public static final String LETTER_SENT= "letter.send";
